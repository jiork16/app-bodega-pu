        ...
        <div x-data="{ dropdownOpen: false }" class="relative">
            ...
            <div x-show="dropdownOpen"
                ...
                <form id="GFG" action="{{ route('logout') }}" method="POST">
                    @csrf
                    <a href="/dashboard"
                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">Ubicacion de
                        Productos</a>
                    @if (Auth::user()->user_type == 'A')
                        <a href="/movimiento"
                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">Movimiento</a>
                    @endif
                    <a href="/despacho"
                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">Despacho</a>
                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white"
                        onclick="myFunction()">Logout</a>
                </form>
            </div>
        </div>
    </div>
